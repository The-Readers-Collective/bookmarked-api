class Mutations::Books::CreateBook < Mutations::BaseMutation
  ...
  def resolve(google_book_id:, isbn_13:, author:, book_title:, book_cover:, category:, condition:, available:)
    book = Book.new(google_book_id: google_book_id, isbn_13: isbn_13, author: author, book_cover: book_cover, category: category, condition: condition, available: available)
