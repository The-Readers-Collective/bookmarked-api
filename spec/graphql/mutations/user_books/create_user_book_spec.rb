    ...
    RSpec.describe CreateUserBook, type: :request do
      describe '.resolve' do
        before :each do
          ...
          @book_1 = Book.create!(google_book_id: "aWZzLPhY4o0C", book_title: "The Fellowship Of The Ring", author: "J.R.R. Tolkien", isbn_13: "9780547952017", condition: 0, category: "Adventure", book_cover:"http://books.google.com/books/content?id=aWZzLPhY4o0C&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api", available: true)
        end
        ...
        it 'returns a user' do
          ...
          expect(data['userBook']['status']).to eq('BOOKMARKED')
        end
