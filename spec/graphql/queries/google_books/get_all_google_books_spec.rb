...
RSpec.describe Types::QueryType do
  describe 'google books by title' do
    it 'will return google books matching title argument', :vcr do
      result = BookmarkedApiSchema.execute(query).as_json
      expect(result["data"]["googleBooks"][0]["bookTitle"]).to eq("Rhythm of War")
    ...
    def query
      <<~GQL
       {
        googleBooks(title: "Rhythm of War") {
          googleBookId
          isbn13
          author
          bookTitle
